...
<acme:form readonly = "true">
	...
	<acme:input-textbox code="authenticated.audit.form.label.auditor" path="auditorName"/>
	<acme:input-textbox code="authenticated.audit.form.label.course" path="courseName"/>
