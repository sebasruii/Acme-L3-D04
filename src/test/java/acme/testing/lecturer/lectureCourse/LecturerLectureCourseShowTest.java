...
public class LecturerLectureCourseShowTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/lecturer/lecture-course/show-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
