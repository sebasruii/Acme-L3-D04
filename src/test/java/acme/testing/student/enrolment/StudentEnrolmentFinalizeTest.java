...
public class StudentEnrolmentFinalizeTest extends TestHarness {
	...
	void test100Positive(final int recordIndex, final String code, final String creditCard, final String cardHolderName, final String expiryDate, final String cvc, final String cardLowerNibble) {
	...
	void test200Negative(final int recordIndex, final String creditCard, final String cardHolderName, final String expiryDate, final String cvc) {
